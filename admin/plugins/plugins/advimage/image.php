...
{
	    if(file_exists("tinyimages/".$filename)==1)
		{  
		   $ext=findexts($filename);
		   $str=substr(str_shuffle('qazwsxedcrfvtgbyhnujmikolp_1234509876'),3,18);
		   $filename=$str.".".$ext;
...
{ 
     if($_FILES['src1']['name']!='')
	 {
	     $filename=$_FILES['src1']['name'];
		   $file=unique($filename);
		  if(!@move_uploaded_file($_FILES['src1']['tmp_name'],"tinyimages/".$file))
		  {
		    echo "Please change image name.";
		  }
$url="http://pressrelease.vmwebideas.com/admin/plugins/tinymce/jscripts/tiny_mce/plugins/advimage/tinyimages/".$file;
	 } 
}
?>
    <form action="#" method="post" enctype="multipart/form-data"> 
						...
						<table class="properties">
							<tr>
								...
								<td colspan="2"><table border="0" cellspacing="0" cellpadding="0">
									<tr> 
									  <td><input name="src1" type="file" id="src1" value="<?=$url?>" class="mceFocus"  /><input type="submit" name="upload" id="upload" value="UPLOAD" class="updateButton" /><input type="hidden" name="src" id="src" value="<?=$url?>" /></td> 
		...
		<div class="mceActionPanel">
			<div style="float: left">
				<input type="button" id="insert" name="insert" value="{#insert}" onclick="ImageDialog.insert();return false;" />
			</div>
