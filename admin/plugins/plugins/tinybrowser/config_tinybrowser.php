...
//$tinybrowser['sessioncheck'] = 'incorpid';
...
$tinybrowser['path']['image'] = '/files/'.$_SESSION['incorpid']."/"; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/files/'.$_SESSION['incorpid']."/"; // Media files location
$tinybrowser['path']['file']  = '/files/'.$_SESSION['incorpid']."/"; // Other files location*/

// File upload paths (set to absolute by default)
$tinybrowser['path']['image'] = '/files/'.$_SESSION['incorpid'].'/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/files/'.$_SESSION['incorpid'].'/media/'; // Media files location
$tinybrowser['path']['file']  = '/files/'.$_SESSION['incorpid'].'/file/'; // Other files location
